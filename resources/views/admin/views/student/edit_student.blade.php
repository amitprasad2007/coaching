      ...
      <div class="row">
        <div class="col-xs-12">
          @if(session()->has("message"))
                    ...
                    @endif
    {!! Form::Model($users,array('route'=> array('editsavestudents',$users->id),'method'=>'Post','class'=>'','autocomplete'=>'off','enctype'=>'multipart/form-data','id'=>'planner-form')) !!}
         
          {!! Form::hidden('id', null, array('required' => 'required', 'placeholder' => 'id', 'class' => 'form-control'))  !!}            
            <div class="row">
    <div class="col-md-6">
