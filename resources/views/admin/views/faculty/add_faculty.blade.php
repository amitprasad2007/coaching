                ...
                @if(session()->has("message"))
                    ...
                    <form role="form" id='frm-add-faculty' method='post' action="{{ route('savefaculty') }}" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="faculty_email">Password</label>
                                <input type="password" class="form-control" id="faculty_password" name='faculty_password' placeholder="Enter faculty password">
                            </div>
                            <div class="form-group">
